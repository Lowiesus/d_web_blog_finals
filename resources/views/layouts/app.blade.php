...
<head>
    ...
    <title>@yield('title', 'LifeCycle - Stories')</title>
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center">
                    <a href="/" class="text-2xl font-bold text-black">
                        <img src="{{ asset('images/LifeCycle-Logo.png') }}" alt="Logo" class="h-38 w-auto">
                    </a>
                </div>
    ...
    <footer class="bg-black text-white py-12 mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-lg font-semibold mb-4">LifeCycle Stories</h3>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
                <p>&copy; 2025 LifeCycle Stories. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
